...
int main() {
  Student stu1 = {.id = "CS001", .name = "Osama", .year = "Third", .grade = 'A'};
  Student stu2 = {.id = "CS002", .name = "Ali", .year = "Second", .grade = 'B'};
  Student stu3 = {.id = "CS003", .name = "Zia", .year = "First", .grade = 'F'};
